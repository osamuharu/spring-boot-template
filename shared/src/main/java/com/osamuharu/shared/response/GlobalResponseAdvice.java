package com.osamuharu.shared.response;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.osamuharu.shared.annotation.ResponseMessage;
import com.osamuharu.shared.dto.ErrorResponseDto;
import com.osamuharu.shared.dto.RestResponseDto;
...
public class GlobalResponseAdvice implements ResponseBodyAdvice<Object> {
  ...
  public @Nullable Object beforeBodyWrite(@Nullable Object body,
    ...
    RestResponseDto<Object> restResponseDto = RestResponseDto
        .builder()
        .data(body)
        .statusCode(status)
        .message(message)
    ...
    if (body instanceof String || selectedConverterType.isAssignableFrom(
      ...
      try {
        return objectMapper.writeValueAsString(restResponseDto);
